...
export default {
  ...
  // Ant Design's real DOM (rc-select's dual option lists, rc-table's virtual
  // list scaffolding) is heavier than the 15s default budget: axe-core alone
  // takes 3-4 real minutes to walk it under jsdom. This does not loosen any
  // assertion, it just gives genuinely slow-but-correct interactions the wall
  // clock time to finish instead of racing Jest's own timeout.
  testTimeout: 300000,
  rootDir: '.',
